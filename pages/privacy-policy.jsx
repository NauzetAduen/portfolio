  ...
  return (
    <>
      ...
      <div className={styles.privacyPolicy}>
        ...
        <p>
          We respect your privacy and am committed to protecting personally
        ...
        <p>
          Website Visitors Like most website operators, we collects
          ...
          information is to better understand how our visitors use its website.
        ...
        <p>
          We only discloses logged in user and commenter IP addresses under the
          same circumstances that it uses and discloses personally-identifying
          information as described below. Gathering of Personally-Identifying
          Information Certain visitors to our websites choose to interact with
          us in ways that require us to gather personally-identifying
          information.
        </p>
        <p>
          The amount and type of information that we gather depends on the
          nature of the interaction. For example, we ask visitors who sign up
          for a blog to provide a username and email address.
        </p>
        <h2>Security</h2>
        <p>
          ...
          cannot guarantee its absolute security. Advertisements Ads appearing
          on our website may be delivered to users by advertising partners, who
          may set cookies. These cookies allow the ad server to recognize your
          ...
          you. This Privacy Policy covers the use of cookies by us and does not
          cover the use of cookies by any advertisers. Links To External Sites
        ...
        <p>
          {" "}
          We may use Google AdWords for remarketing this page uses the
          ...
          plugin. Protection of Certain Personally-Identifying Information we
          disclose potentially personally-identifying and personally-identifying
          ...
          process it on our behalf or to provide services available at our
          website, and (ii) that have agreed not to disclose it to others. Some
          of those employees, contractors and affiliated organizations may be
        ...
        <p>
          ...
          or our rights, third parties or the public at large.
        </p>
        <p>
          If you are a registered user of this website and have supplied your
          email address, we may occasionally send you an email to tell you about
          new features, solicit your feedback, or just keep you up to date with
          what's going on with ourselves and our products. We primarily use our
          blog to communicate this type of information, so we expect to keep
          this type of email to a minimum. If you send us a request (for example
          via a support email or via one of our feedback mechanisms), we reserve
          the right to publish it in order to help us clarify or respond to your
        ...
        <p>
          ...
          Cookies To enrich and perfect your online experience, we uses
          ...
          browser provides to the website each time the visitor returns. We uses
          cookies to help identify and track visitors, their usage of our site,
          and their website access preferences. Our visitors who do not wish to
          have cookies placed on their computers should set their browsers to
          refuse cookies before using our websites, with the drawback that
          certain features of our websites may not function properly without the
          aid of cookies. By continuing to navigate our website without changing
          your cookie settings, you hereby acknowledge and agree to our use of
          cookies.
        </p>
        <h2>Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, we may change its
